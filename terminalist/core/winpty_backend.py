"""WinPtyBackend — pywinpty PtyProcess implementation of PtyBackend."""
...
class WinPtyBackend(PtyBackend):
    """PTY backend using pywinpty PtyProcess (proven in fakeTerm.py)."""
    ...
    def spawn(
        ...
        log("pty", f"WinPtyBackend.spawn: pid={self._proc.pid}")
